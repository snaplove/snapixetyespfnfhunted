--[[
	PROJETO ESP ELABORADO v2 - JANELA ARRASTÁVEL E SCROLL
	- Pressione 'K' para abrir/fechar a interface.
	- A janela agora pode ser arrastada pela barra de título.
	- A lista de jogadores agora tem scroll e funciona corretamente.
	- Todos os jogadores começam com o ESP em modo "OFF" por padrão.
]]
...
-- (O código de criação da UI é o mesmo, sem mudanças aqui)
-- ===================================================================
...
mainFrame.Position = UDim2.new(0, 100, 0.5, -200) -- Posição inicial no canto
mainFrame.AnchorPoint = Vector2.new(0, 0.5)
mainFrame.BackgroundColor3 = Color3.fromRGB(35, 37, 40)
mainFrame.BorderSizePixel = 0
mainFrame.Visible = isUiVisible
mainFrame.ClipsDescendants = true -- Importante para o corner funcionar bem
...
refreshButton.Position = UDim2.new(1, -35, 0, 5)
refreshButton.Text = "R"
refreshButton.Font = Enum.Font.SourceSansBold
refreshButton.TextSize = 18
refreshButton.TextColor3 = Color3.fromRGB(255, 255, 255)
refreshButton.BackgroundColor3 = Color3.fromRGB(50, 52, 56)
refreshButton.Parent = titleLabel
...
scrollingFrame.BackgroundColor3 = mainFrame.BackgroundColor3
...
playerTemplate.BackgroundColor3 = Color3.fromRGB(50, 52, 56)
...
playerIcon.Position = UDim2.new(0, 5, 0.5, -17.5)
playerIcon.BackgroundTransparency = 1
Instance.new("UICorner", playerIcon)

local playerNameLabel = Instance.new("TextLabel", playerTemplate)
playerNameLabel.Name = "PlayerName"
playerNameLabel.Size = UDim2.new(1, -95, 1, 0)
playerNameLabel.Position = UDim2.new(0, 45, 0, 0)
...
espToggleButton.Size = UDim2.new(0, 40, 0, 25)
espToggleButton.Position = UDim2.new(1, -45, 0.5, -12.5)
...
local function updateToggleButton(button, isEnabled)
	if isEnabled then
		button.Text = "ON"
		button.BackgroundColor3 = Color3.fromRGB(70, 180, 80)
	else
		button.Text = "OFF"
...
local function populatePlayerList()
	...
	for _, player in ipairs(Players:GetPlayers()) do
		...
		playerFrame.PlayerName.Text = player.DisplayName
		...
		-- MUDANÇA: Todos começam com ESP desligado
		if espTargets[player] == nil then
			espTargets[player] = false
		end
	...
	-- MUDANÇA: Lógica para fazer o scroll funcionar
	-- Calcula o tamanho total do conteúdo e atualiza o CanvasSize
...
-- ===================================================================
-- 3. LÓGICA DO ESP (DESENHO) - Sem mudanças aqui
-- ===================================================================
-- (O código de desenho do ESP permanece o mesmo, pois já é robusto)
...
local function updateEsp()
	...
	for player, isEnabled in pairs(espTargets) do
		...
		if pointsOnScreen > 0 then
			...
			local boxWidth = maxX - minX; local boxHeight = maxY - minY
...
-- ===================================================================
-- 4. NOVO: LÓGICA PARA ARRASTAR A JANELA
-- ===================================================================
...
Players.PlayerRemoving:Connect(function(player)
	...
	if espDrawings[player] then
		for _, line in pairs(espDrawings[player]) do line:Remove() end
